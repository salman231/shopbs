...
namespace Vmj\Custom\Block\Adminhtml\Customer\Edit;
...
class Tabs extends Generic implements TabInterface
{
    ...
    public function initForm()
    {
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'name' => 'registerwithvat',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('Register With TAX?'),
                'title' => __('Register With TAX?'),
                'value' => $customer->getregisterwithvat(),
                'values'    => [
