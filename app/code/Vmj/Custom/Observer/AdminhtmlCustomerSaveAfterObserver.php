    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($this->isSeller($customerid)) {
            ...
            if (empty($errors)) {
                ...
                /*following hard code sql is used because registerwithvat field not created using standard way by prev developer*/

                if (isset($postData['registerwithvat'])) {
                    ...
                    $sql = "UPDATE $tableName SET `registerwithvat` = '".$postData['registerwithvat']."'  WHERE $tableName.`entity_id` = ".$sellerId;
