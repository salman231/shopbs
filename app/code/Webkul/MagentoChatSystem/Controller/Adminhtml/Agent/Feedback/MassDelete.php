...
class MassDelete extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Webkul_MagentoChatSystem::AgentRating_delete';
     ...
     * @param AgentRatingRepositoryInterface $repository
     */
    public function __construct(
        Context $context,
        Filter $filter,
        CollectionFactory $collectionFactory,
        AgentRatingRepositoryInterface $repository
    ) {
        $this->filter = $filter;
