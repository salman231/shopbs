    ...
    public function prepareDataSource(array $dataSource)
    {
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                $itmorder = $objectManager->create('Magento\Sales\Api\OrderItemRepositoryInterface')->get($item['order_item_id']);
                ...
                if ($taxToSeller) {
                    ...
                    $selleractamt = $item['actual_seller_amount']*($itmorder->getTaxPercent()/100);
