...
/**
 * Class OutstandingBalanceDataProvider
 */
class OutstandingBalanceDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
    ...
    public function __construct(
        ...
        $collectionData->addFieldToFilter('order_status', array('in' => array('pending'))); // This is Order Status Filter
        $collectionData->setOrder('main_table.order_id', 'DESC');
        $collectionData->getSelect()->limit(100);
