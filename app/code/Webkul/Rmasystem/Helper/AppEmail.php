...
class AppEmail extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
    ...
    */
     ...
     * @throws \Exception
     */
    public function sendNewRmaEmail($post, $rma, $customerid)
    {
    ...
    public function newMessageEmail($post, $rma, $selfEmail, $fileName, $customerid)
    {
    ...
    public function updateRmaEmail($post, $rma, $statusFlag, $deliveryFlag, $selfEmail, $fileName,$customerid)
    {
        $filePath = $this->helper->getConversationDir($rma->getId());
        $temp_path = '';
