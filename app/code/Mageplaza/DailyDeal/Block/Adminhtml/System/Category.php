 ...
 */
class Category extends Field implements BlockInterface
{
    /**
    ...
    public function _getElementHtml(AbstractElement $element)
    {
        ...
        $html .= '<div id="mpdailydeal_general_category"  class="admin__field" data-bind="scope:\'category\'" data-index="index">';
        $html .= '<!-- ko foreach: elems() -->';
        $html .= '<input class="input-text admin__control-text" type="text" name="groups[create_deal][fields][category][value]" data-bind="value: value" style="display: none;"/>';
    ...
    {
        $values = $this->getConfigData('dailydeal/create_deal/category');
        if (!$values) {
