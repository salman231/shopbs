...
2. Remove BetterProductReviews folder

In case of customization, you should backup the customized files and modify in newer version.
Now you remove `app/code/Mageplaza/BetterProductReviews` folder. In this step, you can copy override BetterProductReviews folder but this may cause of compilation issue. That why you should remove it.
